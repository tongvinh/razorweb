    ...
    public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
    {
      ...
      if (ModelState.IsValid)
      {
        ...
        if (registeredUser != null && externalEmailUser != null)
        {
          ...
          {
            // registeredUser = externa LEmailUser (externa lEmail != Input.Email)
            /*
              info user1 (maill@abc.com)
                   user2 (mail2@abc.com)
            */
        ...
        {
          ModelState.AddModelError(string.Empty, "Không hổ trợ tại tài khoản mới - có email khác với dịch vụ ngoài");
          return Page();
        }
        if ((externalEmailUser == null) && (externalEmail == Input.Email))
        {
          // Chưa có tài khoản , liên kết, đăng nhập
